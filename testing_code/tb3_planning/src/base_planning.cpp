...
//   static const std::string PLANNING_GROUP = "tb3";
  ...
  visual_tools.publishText(text_pose, "base planning Demo debug", rvt::WHITE,
                           rvt::XLARGE);
  ...
  std::string planning_target_link = "base_footprint";
// std::string planning_target_link = "end_effector_link";
...
//   move_group.setJointValueTarget(joint_group_positions);
  move_group.setApproximateJointValueTarget(target_pose1, planning_target_link);

  // move_group.setPoseTarget(target_pose1, planning_target_link);
