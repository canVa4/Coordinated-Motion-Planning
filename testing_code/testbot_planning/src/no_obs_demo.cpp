...
int main(int argc, char** argv)
{
  ...
  visual_tools.publishText(text_pose, "No Obstacle Demo", rvt::WHITE, rvt::XLARGE);
  ...
  ROS_INFO_NAMED("No Obstacle Demo", "Reference frame: %s", move_group.getPlanningFrame().c_str());
  
  // We can also print the name of the end-effector link for this group.
  ROS_INFO_NAMED("No Obstacle Demo", "End effector link: %s", move_group.getEndEffectorLink().c_str());
